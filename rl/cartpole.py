...
if gym.__version__[:4] == '0.26':
    ...
    raise ImportError(f"Requires gym v25 or v26, actual version: \
            {gym.__version__}")
...
def select_action(state):
    ...
    if sample > eps_threshold:
        with torch.no_grad():
            # t_max(1) will return largest column value of each row.
            # Second column on max result is the index of where max element was 
