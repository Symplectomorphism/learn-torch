...
# The Dataset retreives our dataset's features and labels one sample at a time.
# While training a model, we typically want to pass samples in "minibatches",
# reshuffle the data at every epoch to reduce model overfitting, and use
# Python's multiprocessing to speed up data retreival.
...
# Each iteration below returns a batch of train_features and train_lables
